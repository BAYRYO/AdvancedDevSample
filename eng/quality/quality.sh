...
GLOBAL_LINE_THRESHOLD="${GLOBAL_LINE_THRESHOLD:-60}"
INFRA_LINE_THRESHOLD="${INFRA_LINE_THRESHOLD:-45}"
FRONTEND_LINE_THRESHOLD="${FRONTEND_LINE_THRESHOLD:-8}"
...
GLOBAL_LINE_THRESHOLD="${GLOBAL_LINE_THRESHOLD}" \
INFRA_LINE_THRESHOLD="${INFRA_LINE_THRESHOLD}" \
FRONTEND_LINE_THRESHOLD="${FRONTEND_LINE_THRESHOLD}" \
"${REPO_ROOT}/eng/quality/check-coverage.sh" "${COVERAGE_FILE}"
