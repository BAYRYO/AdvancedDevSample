...
public class PriceTests
{
    ...
    {
        var exception = Assert.Throws<DomainException>(() => new Price(-10));
        Assert.Equal("Un prix doit etre strictement positif.", exception.Message);
    }
    ...
    {
        var exception = Assert.Throws<DomainException>(() => new Price(0.001m));
    ...
    {
        var exception = Assert.Throws<DomainException>(() => new Price(1000000m));
